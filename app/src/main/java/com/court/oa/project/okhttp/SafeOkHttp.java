...
public class SafeOkHttp {
    ...
    /**
     * 获取带有制定输入流的认证证书�? OkHttpClient
     * 构�?�CertificateFactory对象，�?�过它的generateCertificate(is)方法得到Certificate�?
     ...
     * �?后，设置我们mOkHttpClient.setSslSocketFactory即可�?
     *
     * @param certificates 证书输入�?
     * @return OkHttpClient
     * @throws Exception
     */
